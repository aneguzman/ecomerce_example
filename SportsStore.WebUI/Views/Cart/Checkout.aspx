...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
	...
	<div>
		Name:
		<%: Html.EditorFor(x => x.Name) %></div>
	<h3>
		Address</h3>
	<div>
		Line 1:
		<%: Html.EditorFor(x => x.Line1) %></div>
	<div>
		Line 2:
		<%: Html.EditorFor(x => x.Line2) %></div>
	<div>
		Line 3:
		<%: Html.EditorFor(x => x.Line3) %></div>
	<div>
		City:
		<%: Html.EditorFor(x => x.City) %></div>
	<div>
		State:
		<%: Html.EditorFor(x => x.State) %></div>
	<div>
		Zip:
		<%: Html.EditorFor(x => x.Zip) %></div>
	<div>
		Country:
